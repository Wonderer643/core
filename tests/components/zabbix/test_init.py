...
async def test_async_setup_entry_sensor_userpass_success(
    ...
    with (
        ...
        assert sensors_setup_mock.call_count == 1
        assert sensors_setup_mock.call_args.args[0] == entry
        assert sensors_setup_mock.call_args.args[1] == "sensor"
